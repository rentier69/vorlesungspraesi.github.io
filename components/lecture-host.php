...
<body>
    ...
    <div role="main" class="container-fluid">
        <div class="row">
            ...
            <div class="col">
                <a onclick="closeLecture(<?= $v_id ?>);" href="../index.php" class="btn btn-sm btn-outline-secondary">
        ...
        <div class="row">
            <button class="btn btn-primary form-group" name="sendMessage" id="sendMessage" disabled>Send</button>
            <button onClick="deleteChat();" class="btn btn-danger form-group" name="deleteChat" id="deleteChat" >Chat löschen</button>
        </div>
        <div class="row">
