    ...
    <body>
        ...
        <script>
            ...
            xhr.onload = function () {
                ...
                //document.getElementsByTagName("main").innerHTML = this.response;
            };
            xhr.send();
            ...
            var xhr = new XMLHttpRequest();
            xhr.open('POST', "backend-api.php?mode=users&action=displayAll", true);
            xhr.onload = function () {
                ...
                var tbody = "";
                for (let row of data) {
                    tbody += '<tr onclick="changeMode(\'useredit\')">';
