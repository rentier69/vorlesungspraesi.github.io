    ...
    switch (mode) {
        case "home":
            getData("get", "static/home.html", null, "html").done(function (data) {
                setStaticHtml(data);
                getData("get", "lecture-host-api.php?mode=lectures&action=getAll", null).done(prepareHomePage);
            });
...
function createUser() {    
    ...
    getData("post", "lecture-host-api.php?mode=users&action=create", data).done(function(data){
        changeMode('users');
...
function loadUserList(data) {
    if (data == null) {
        getData("get", "lecture-host-api.php?mode=users&action=getAll", null).done(loadUserList);
    } else {        
        // Build HTML table with given data
        var tbody = "";
        for (let row of data) {
...
var editUser = {
    ...
    queryDetails: function () {
        var url = "lecture-host-api.php?mode=users&action=getById&u_id=" + editUser.benutzer_id;
        getData("get", url, null).done(editUser.setDetails);
    },
    queryGroupMembership: function () {
        var url = "lecture-host-api.php?mode=users&action=getGroupMembership&u_id=" + editUser.benutzer_id;
    ...
    activate: function () {
        var url = "lecture-host-api.php?mode=users&action=activate";
        var data = {
    ...
    deactivate: function () {
        var url = "lecture-host-api.php?mode=users&action=deactivate";
        var data = {
            id: editUser.benutzer_id
        }
        getData("post", url, data, "text").done(function(data){
    ...
    rename: function () {
        var url = "lecture-host-api.php?mode=users&action=rename";
        var data = {
    ...
    resetPasswort: function () {
        var url = "lecture-host-api.php?mode=users&action=resetPw";
        var data = {
            id: editUser.benutzer_id,
            pw: document.getElementById("password1").value
        }
    ...
    addToGroup: function (group_id) {
        var url = "lecture-host-api.php?mode=users&action=addToGroup";
        var data = {
    ...
    removeFromGroup: function (group_id) {
        var url = "lecture-host-api.php?mode=users&action=removeFromGroup";
        var data = {
            u_id: editUser.benutzer_id,
            g_id: group_id
        }
    ...
    delete: function () {
        var url = "lecture-host-api.php?mode=users&action=delete";
        var data = {
            id: editUser.benutzer_id
        }
        getData("post", url, data, "text").done(function(){
...
function loadGroupList(data) {
    if (data == null) {
        getData("get", "lecture-host-api.php?mode=groups&action=getAll", null).done(loadGroupList);
    } else {
        // Build HTML table with given data
        var tbody = "";
        for (let row of data) {
...
function createGroup(){
    ...
    getData("post", "lecture-host-api.php?mode=groups&action=create", data).done(function(data){
...
var editGroup = {
    ...
    groupMembership: null,
    queryDetails: function () {
        var url = "lecture-host-api.php?mode=groups&action=getById&g_id=" + editGroup.gruppen_id;
        getData("get", url, null).done(editGroup.setDetails);
    },
    queryGroupMembership: function () {
        var url = "lecture-host-api.php?mode=groups&action=getGroupMembership&g_id=" + editGroup.gruppen_id;
    ...
    rename: function () {
        var url = "lecture-host-api.php?mode=groups&action=rename";
        var data = {
    ...
    addToGroup: function (benutzer_id) {
        var url = "lecture-host-api.php?mode=groups&action=addToGroup";
        var data = {
            u_id: benutzer_id,
            g_id: editGroup.gruppen_id
        }
    ...
    removeFromGroup: function (benutzer_id) {
        var url = "lecture-host-api.php?mode=groups&action=removeFromGroup";
        var data = {
            u_id: benutzer_id,
            g_id: editGroup.gruppen_id
        }
    ...
    delete: function () {
        var url = "lecture-host-api.php?mode=groups&action=delete";
        var data = {
            g_id: editGroup.gruppen_id
        }
        getData("post", url, data, "text").done(function(data){
...
function createLecture(data) {
    ...
    getData("post", "lecture-host-api.php?mode=lectures&action=create", data).done(function(data){
        changeMode('lectures');
...
function loadLectureList(data) {
    if (data == null) {
        getData("get", "lecture-host-api.php?mode=lectures&action=getAll", null).done(loadLectureList);
    } else {
        // Build HTML table with given data
        var tbody = "";
        for (let row of data) {
...
var editLecture = {
    ...
    queryDetails: function () {
        var url = "lecture-host-api.php?mode=lectures&action=getById&v_id=" + editLecture.vorlesung_id;
        getData("get", url, null).done(editLecture.setDetails);
    },
    queryQuestions: function () {
        var url = "lecture-host-api.php?mode=lectures&action=getQuestions&v_id=" + editLecture.vorlesung_id;
        getData("get", url, null).done(editLecture.setQuestions);
    },
    queryAssignedGroups: function () {
        var url = "lecture-host-api.php?mode=lectures&action=getAssignedGroups&v_id=" + editLecture.vorlesung_id;
    ...
    onSortSelect : function (value){
        ...
        var url = "lecture-host-api.php?mode=lecturequestion&action=setRank";
        var data = {
            "q_id": selected.q_id,
            "rank": selected.rank
        }
    ...
    rename: function () {
        var url = "lecture-host-api.php?mode=lectures&action=rename";
        var data = {
            name: document.getElementById("newName").value,
    ...
    assignToGroup: function (group_id) {
        var url = "lecture-host-api.php?mode=lectures&action=assignToGroup";
        var data = {
            v_id: editLecture.vorlesung_id,
            g_id: group_id
        }
    ...
    unassignFromGroup: function (group_id) {
        var url = "lecture-host-api.php?mode=lectures&action=unassignFromGroup";
        var data = {
            v_id: editLecture.vorlesung_id,
            g_id: group_id
        }
    ...
    delete: function () {
        var url = "lecture-host-api.php?mode=lectures&action=delete";
        var data = {
            v_id: editLecture.vorlesung_id
        }
        getData("post", url, data, "text").done(function(data){
...
var createQuestion = {
    ...
    queryQuestionTypes: function () {
        var url = "lecture-host-api.php?mode=lecturequestion&action=getQuestionTypes";
    ...
    save: function () {
        var url = "lecture-host-api.php?mode=lecturequestion&action=create";
        var data = {
            "v_id": editLecture.vorlesung_id,
...
var editQuestion = {
    ...
    queryQuestionDetails: function () {
        var url = "lecture-host-api.php?mode=lecturequestion&action=getById&q_id=" + editQuestion.questionId;
        getData("post", url, null).done(editQuestion.setQuestionDetails);
    },
    queryQuestionAnswerOptions: function () {
        var url = "lecture-host-api.php?mode=lecturequestion&action=getAllAnswerOptionsByQId&q_id=" + editQuestion.questionId;
        getData("post", url, null).done(editQuestion.setQuestionAnswerOptions);
    },
    queryHasGivenAnswers: function () {
        var url = "lecture-host-api.php?mode=lecturequestion&action=hasGivenAnswer&q_id=" + editQuestion.questionId;
    ...
    delete: function () {
        var url = "lecture-host-api.php?mode=lecturequestion&action=delete";
        var data = {
    ...
    save: function () {
        if (editQuestion.hasGivenAnswers) {
            var url = "lecture-host-api.php?mode=lecturequestion&action=createNewVersion";
        } else {
            var url = "lecture-host-api.php?mode=lecturequestion&action=modifyExistingVersion";
        }
        var data = {
            "q_id": editQuestion.questionId,
